<template>
  <div class="registerManage">
    ...
    <el-table :data="patients" border style="width: 100%; text-align:left" >
      <el-table-column prop="number" label="挂号序号" align="center"></el-table-column>
      <el-table-column prop="patientName" label="患者姓名" align="center"></el-table-column>
      <el-table-column prop="certificateValue" label="挂号凭证" align="center"></el-table-column>
      <el-table-column prop="cardNumber" label="凭证号" align="center"></el-table-column>
      <el-table-column prop="departmentValue" label="科室" align="center"></el-table-column>
      <el-table-column prop="doctorName" label="就诊医生" align="center"></el-table-column>
      <el-table-column prop="visitDate" label="就诊时间" align="center"></el-table-column>
      <el-table-column prop="no" label="候诊号" align="center"></el-table-column>
      <el-table-column prop="expense" label="挂号费" align="center"></el-table-column>
