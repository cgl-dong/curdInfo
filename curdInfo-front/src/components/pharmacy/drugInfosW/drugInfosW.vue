<template>
  <div class="drugInfosW">
    ...
    <div class="filter-container">
      <el-input placeholder="药品名（支持模糊查询）" v-model="searchValue"></el-input>
    ...
    <el-table :data="tableData" border style="width: 100%; text-align:left">
      ...
      <el-table-column prop="expiryDate" label="有效期至" width="130"></el-table-column>
...
<script type="text/ecmascript-6">
  export default {
    ...
    created () {
      ...
      druginfosThis.$axios.get('his/drug/w').then((response) => {
    ...
    methods: {
      ...
      search () {
        ...
        intendedSearch.$axios.post('his/drug/w/search?name=' + intendedSearch.searchValue).then((response) => {
