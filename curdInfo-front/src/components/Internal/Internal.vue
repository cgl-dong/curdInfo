      ...
      <div class="menu" :class="{ smallNav: isCollapse }">
        <el-menu default-active="1-4-1" class="el-menu-vertical-demo"  :collapse="isCollapse"  theme="dark">
          ...
          <el-submenu index="9">
            ...
            <el-menu-item-group>
              <!-- <el-menu-item index="8-1"><router-link to="hisIntroduction">医院基本介绍</router-link></el-menu-item> -->
              <el-menu-item index="9-1"><router-link to="notice">发布公告</router-link></el-menu-item>
              <el-menu-item index="9-2"><router-link to="allChat">聊天</router-link></el-menu-item>
              <el-menu-item index="9-3"><router-link to="sendMail">发邮件</router-link></el-menu-item>
            </el-menu-item-group>
          </el-submenu>
          ...
          <el-submenu index="10">
            ...
            <el-menu-item-group>
              <!-- <el-menu-item index="8-1"><router-link to="hisIntroduction">医院基本介绍</router-link></el-menu-item> -->
              <el-menu-item index="10-1"><router-link to="sys_user">用户管理</router-link></el-menu-item>
              <el-menu-item index="10-2"><router-link to="b">角色管理</router-link></el-menu-item>
              <el-menu-item index="10-3"><router-link to="c">部门管理</router-link></el-menu-item>
            </el-menu-item-group>
          </el-submenu>
          <el-menu-item index="1"  @click="navToggle">
            <template>
          ...
          <el-menu-item index="10"  @click="toHome">
            <template>
